...
const DailyTournamentNewTesting7: React.FC<DailyTournament> = ({
    dailyTournaments,
}) => {
                                        ...
                                        >
                                            ...
                                            <div className="relative w-full aspect-[285/380] rounded-xl overflow-hidden shadow-sm">
                                                ...
                                                <button
                                                    ...
                                                    className="absolute top-2 right-2 z-10 w-7 h-7 rounded-full flex items-center justify-center bg-brand-gradient hover:brightness-110 text-brand-black-100 shadow-md active:scale-90 transition-all shrink-0 pointer-events-auto"
                                            ...
                                            {/* Reward Row */}
                                            <div className="flex justify-center items-center px-2 py-1.5 mt-1 bg-slate-100/80 dark:bg-white/[0.03] border border-slate-200/60 dark:border-white/[0.04] rounded-xl whitespace-nowrap">
...
export default DailyTournamentNewTesting7;
