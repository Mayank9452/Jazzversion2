...
import { Clock, Star, Play, Coins } from "lucide-react";
...
interface JazzPremiumZoneProps {
    heroGames: HeroGames[];
...
const JazzPremiumZone: React.FC<JazzPremiumZoneProps> = ({ heroGames, onCountdownChange }) => {
                                        ...
                                        >
                                            ...
                                            <div className={`flex justify-between items-center mx-1 px-2.5 py-2 border-t rounded-b-[24px] transition-all duration-300 ${isDark
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div>
                                                        <div className={`text-[12px] font-bold leading-none tracking-[0.5px] ${isDark ? "text-slate-800 dark:text-white" : "text-slate-600"}`}>Prize Pool</div>
                                                        <div className={`text-sm font-black mt-1 tracking-[0.5px] ${isDark ? "text-brand-gold-100 dark:text-brand-yellow-100" : "text-slate-800 font-extrabold"}`}>
...
export default JazzPremiumZone;
