...
const DailyTournamentNewTestingV: React.FC<DailyTournament> = ({
    dailyTournaments,
}) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {/* Coins & Play/Join Button Row (Styled as a horizontal strip) */}
                                            <div className="flex justify-between items-center px-2 py-1.5 mt-1 bg-slate-100/80 dark:bg-white/[0.03] border border-slate-200/60 dark:border-white/[0.04] rounded-xl whitespace-nowrap">
                                                <div className="font-extrabold flex items-center gap-1 text-sm sm:text-xs">
                                                    ...
                                                    {game?.fee_reward_type === "2" && (
                                                        <span className="tracking-wide text-slate-800 dark:text-brand-yellow-300 font-bold">
                                                ...
                                                <button
                                                    className="w-6 h-6 rounded-lg flex items-center justify-center bg-brand-gradient hover:brightness-110 text-brand-black-100 shadow-md active:scale-90 transition-all shrink-0 pointer-events-auto"
...
export default DailyTournamentNewTestingV;
