...
const TournamentHistoryUpdated: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-background text-foreground transition-colors duration-300 mb-8">
                ...
                {/* ── Stats row 2 (Shorter Numbers, slides) ── */}
                <div
                    className="overflow-hidden w-full px-4 pb-2.5 flex"
                >
                    <motion.div
                        className="flex gap-2.5 shrink-0 mt-2"
                        animate={{ x: ["0%", "-50%"] }}
                        transition={{
                            ease: "linear",
                            duration: 18,
                    ...
                    >
                        {[
                            {
                                val: formatShortNumber(displayPlayed),
                                label: "Played",
                                color: "gold",
                                icon: <Gamepad2 className="w-6 h-6 text-yellow-main" />,
                                lineColor: "bg-yellow-main",
                            ...
                            {
                                val: formatShortNumber(displayWins),
                                label: "Won",
                                color: "gold",
                                icon: <Trophy className="w-6 h-6 text-yellow-main" />,
                                lineColor: "bg-yellow-main",
                            ...
                            {
                                val: formatShortNumber(displayCoins),
                                label: "Coins",
                                color: "gold",
                                icon: <Coins className="w-6 h-6 text-yellow-main" />,
                                lineColor: "bg-yellow-main",
                            ...
                            {
                                val: formatShortNumber(displayVouchers),
                                label: "Giftkarte",
                                color: "gold",
                                icon: <Gift className="w-6 h-6 text-yellow-main" />,
                                lineColor: "bg-yellow-main",
                            ...
                            {
                                val: formatShortNumber(displayTalktime),
                                label: "Topup",
                                color: "gold",
                                icon: <TopupIcon className="w-6 h-6" />,
                                lineColor: "bg-yellow-main",
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Middle: Value */}
                                    <span className={`text-[13px] sm:text-sm font-black ${valColor} tracking-wide leading-none truncate max-w-full px-1`}>
                                        {val}
                                    </span>
...
export default TournamentHistoryUpdated;