...
export default function SettingsPageNewStatic() {
    ...
    const [currentAvatar, setCurrentAvatar] = useState<string>("1.png");
    const [userCoins, setUserCoins] = useState<number>(3256);
        ...
        <>
            ...
            <div className="relative bg-[#F8F9FA] dark:bg-black text-foreground overflow-x-hidden min-h-screen pb-8 transition-colors duration-300">
                ...
                <div className="relative z-10">
                    ...
                    <div className="mt-4 text-center flex flex-col items-center px-4 relative z-10">
                        <div className="px-5 py-2 rounded-2xl bg-gradient-to-r from-[#FFCA20] to-[#DFA208] border-2 border-white dark:shadow-md flex items-center gap-2.5">
                            {/* <Phone className="w-3.5 h-3.5 text-black fill-current" /> */}
                            <span className="text-[14px] font-black tracking-wider text-black select-none">
                                {phoneShowFormat(user?.user_phone) || "959xxxx879"}
                            </span>
                        </div>
                    </div>
                    {/* Statistics Section */}
                    ...
                    <div className="px-4 mt-6 max-w-md mx-auto flex flex-col gap-3">
                        ...
                        <button
                            ...
                            className={`w-full p-4 flex items-center justify-between rounded-2xl border transition-all duration-200 active:scale-[0.98] group relative z-10 ${isDark
                                ...
                                : "bg-white border-slate-100 hover:bg-slate-50 shadow-[0_1px_2px_rgba(0,0,0,0.26)]"
                                }`}
                        >
