...
interface PopupNotJoinedLeaderboardProps {
  onClose: () => void;
  t: any;
  activeTab: string;
}

const PopupNotJoinedLeaderboard = ({
  onClose,
  t,
  activeTab,
}: PopupNotJoinedLeaderboardProps) => {
  const navigate = useNavigate();
  const description =
    activeTab === "weekly"
      ? t.notJoinedWeeklyDesc
      : t.notJoinedMonthlyDesc;
...
export default PopupNotJoinedLeaderboard;
