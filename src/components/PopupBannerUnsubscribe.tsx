    ...
    <AnimatePresence>
      {isShow && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/40 backdrop-blur-[5px] will-change-transform"
          style={{ marginTop: "0px" }}
          onClick={handleClose}
        >
          <motion.div
          ...
          >
            ...
            >
              ...
              <div className="relative flex justify-center">
                ...
                >
                  <div className="absolute -inset-2 blur-xl rounded-full transition-opacity" />
