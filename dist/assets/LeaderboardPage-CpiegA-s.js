import{r as d,j as e}from"./index-Bwm3dqXp.js";import{L as a}from"./mockData-CFswUJMN.js";function c({weeklyUsers:n,monthlyUsers:o}){const[t,s]=d.useState("weekly"),i=t==="weekly"?n:o;return e.jsxs("div",{className:"glass-card rounded-2xl p-5 card-shadow ",children:[e.jsxs("div",{className:"relative flex w-fit rounded-xl bg-black/20 p-1 mb-4 m-auto",children:[e.jsx("span",{className:`absolute top-1 bottom-1 w-1/2 rounded-lg transition-all duration-300
